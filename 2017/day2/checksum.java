...
{   
    public static int minMaxDifference(int[] intList)
    {   
            int difference = 0;
            int min = intList[0];
            int max = intList[0];
            //2. find min max for each int array
    ...
    public static void main(String[] args)
    {
        ...
        for(int i=0; i < inputList.length; i++)
        {
            ...
            sumOfDifferences += minMaxDifference(intList);
        }
        
        
        System.out.println("Result: " + sumOfDifferences);
